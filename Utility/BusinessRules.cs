...
namespace Utility
{
    ...
    public static class BusinessRules
    {
        ...
        public static string TrimAccount(string accountType)
        {
            string newAccount = accountType.Substring(0, accountType.IndexOf("_"));

             newAccount = newAccount.Replace("Account", "");
